...
| [`cdp/`](cdp/) | Caliendo, Dvorkin, Parro — dynamic labor-market trade model | [author site](https://sites.google.com/site/lorenzocaliendo/research/cdp) | Phase 1 + full Phase 2 done (static 2000 base year + 2000-2007 dynamic baseline + 2007-forward simulation + stitch); counterfactual (Phase 3) next |
